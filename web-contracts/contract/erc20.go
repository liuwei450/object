...
// Erc20 是围绕以太坊合约的 Go 绑定 Erc20 is an auto generated Go binding around an Ethereum contract.
type Erc20 struct {
	Erc20Caller     // 只读绑定 Read-only binding to the contract
	Erc20Transactor // 写绑定 Write-only binding to the contract
	Erc20Filterer   // 日志过滤器 Log filterer for contract events
}

// Erc20Caller is an auto generated read-only Go binding around an Ethereum contract.
//NewErc20 创建一个新的 Erc20 实例，并绑定到指定的已部署合约
